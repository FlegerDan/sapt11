...
)
{
    ...
    */
        ...
        )
    {
        ...
        if (pCurrentReservation->PageRights == VMM_ALLOC_TYPE_COMMIT)
        {
            dimensiune = dimensiune + (DWORD)pCurrentReservation->Size;
        }
        
    }
    NumberOfPagesCommited = dimensiune / PAGE_SIZE;
...
)
{
    ...
    */
        ...
        )
    {
        ...
        if (pCurrentReservation->PageRights == VMM_ALLOC_TYPE_RESERVE)
        {
            dimensiune = dimensiune + (DWORD)pCurrentReservation->Size;
        }

    }
    NumberOfPagesReserved = dimensiune / PAGE_SIZE;
